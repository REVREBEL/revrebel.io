...
2. Include the script on the page(s) where you’d like to use it.
   Change queryForm() to queryForm({reset: true}) to reset values upon form submission.

Usage
<script src="https://revrebel.github.io/revrebel.io/scripts/sup.min.js"></script>
