# Save as: C:\Scripts\Copy-DemandDatabaseFiles.ps1
# Example dry run:
...
param(
  ...
  [string]$SourceRoot = "C:\Users\admin\OneDrive - Aparium Hotel Group\Demand Reporting - Demand Datastore\_database",

  # COPY TO HERE (REVREBEL intake)
  [string]$DestinationRoot = "C:\Users\admin\OneDrive - REVREBEL\Demand Reporting - Documents\_data-ingestion",
